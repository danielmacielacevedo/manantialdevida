      ...
      <div className="TextContainer">
        ...
        <div className="TextContent">
          <p>
            ...
            SomosManantial usa y protege la información que es proporcionada por
            sus usuarios al momento de utilizar su aplicación web. Esta
            organización está comprometida con la seguridad de los datos de sus
            ...
            enfatizamos revisar continuamente esta página para asegurarse que
          ...
          <p>
            Nuestra aplicación web podrá recoger información personal, por
            ...
            alguna petición del usuario.
          </p>

          <h3>USO DE LA INFORMACIÓN RECOGIDA</h3>

          <p>
            Nuestra aplicación web emplea la información con el fin de
            proporcionar el mejor servicio posible, particularmente para
            mantener un registro de usuarios, y mejorar nuestros servicios. Es
            posible que sean enviados correos electrónicos periódicamente a
            través de nuestro sitio con avisos especiales, nuevos eventos y otra
          ...
          <p>
            SomosManantial está altamente comprometido para cumplir con el
          ...
          <p>
            ...
            que con ellas las webs pueden reconocerte individualmente y, por
            tanto, brindarte el mejor servicio personalizado de su web.
          </p>

          <p>
            Nuestra aplicación web emplea las cookies para poder identificar las
          ...
          <p>
            Esta aplicación web pudiera contener enlaces a otros sitios que
            pudieran ser de su interés. Una vez que usted dé clic en estos
          ...
          <p>
            ...
            aplicación web. Cada vez que se le solicite rellenar un formulario,
          ...
          <p>
            Esta organización no venderá, cederá ni distribuirá la información
            personal que es recopilada sin su consentimiento, salvo que sea
            requerido por un juez con una orden judicial.
          </p>

          <p>
            SomosManantial Se reserva el derecho de cambiar los términos de la
