...
import ReproductorBlog from "./Reproductor/ReproductorBlog";
      ...
      <div className="CoverPredicaContainer">
        ...
        <div className="CoverSectionsContainer">
          <section className="LeftSection">
            ...
            /> */}
            <h3>Recomendación del autor</h3>
            <ReproductorBlog embed="MjMcj453CYQ" />
            <h3>Dale play y continúa la lectura...</h3>
          </section>
        </div>
      </div>
      <style jsx>{`
