...
function detallesVideos(req, res) {
    ...
    const pastorIsaac = [
        ...
        },
        {
            ...
            picture: "/assets/predicadores/pastor-isaac.png",
            date: "19 ABRIL 2023",
            desc: "Predicaci\xf3n Especial de nuestro primer servicio de Aniversario en Manantial de Vida.",
    ...
    const adrielRamos = [
        {
            title: "\xbfCu\xe1nto dependes de Dios?",
            autor: "Adriel Ramos",
    ...
    const franciscoGarcia = [
        {
            ...
            desc: "Predicaci\xf3n Campamento de J\xf3venes Conectados 2021",
        ...
        },
        {
            ...
            picture: "/assets/predicadores/francisco-garcia.png",
            date: "21 ABRIL 2023",
            desc: "Predicaci\xf3n especial de nuestro segundo servicio de Aniversario en Manantial de Vida.",
    ...
    const leonorRuiz = [
        {
            title: "3 Ense\xf1anzas edificantes para la Iglesia",
            autor: "Leonor Ruiz",
    ...
    const omarMorales = [
        {
            title: "Qu\xe9 hacer al cruzar la tempestad",
            autor: "Omar Morales",
    ...
    const yolandaPerez = [
        {
            title: "\xbfPorqu\xe9 busc\xe1is entre los muertos al que vive?",
            autor: "Yolanda P\xe9rez",
